        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="../Admin/WhatsappKontak" class="nav-link">
              <i class="nav-icon fab fa-android"></i><p>Whatsapp Contact</p>
            </a>
          </li>>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Whatsapp Gateway Users Management</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
        </div><!-- /.row -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <?php foreach($tbl_users as $row):?>
                    <tr>
                      <td><?= $row->nama;?></td>
                      <td><center><?php if($row->isonline == "ONLINE"){
                      
                      ?>
                      <span class="badge bg-success">USER ONLINE!</span>
                      <?php
                      }elseif($row->isonline == "OFFLINE"){
                      
                      ?>
                      <span class="badge bg-danger">USER OFFLINE!</span>
                      <?php
                      }
                      ?>
                      </center>
                      </td>
                      <td><center><?php if($row->status == "A"){
                      ...
                      ?>
                      <span class="badge bg-warning">AKUN BANNED!</span>
                      <?php
                      }
                      ?>
                      </center>
                      </td>
                      <td><center><?php if($row->levelakses == "Admin"){
                      
                      ?>
                      <span class="badge bg-info">SUPERIOR!</span>
                      <?php
                      }elseif($row->levelakses == "Users"){
                      ...
                      <td><a href="/Admin/UserEdit/<?= $row->uid;?>" class="btn btn-flat btn-danger"><i class="fas fa-edit"></i> EDIT</a></td>
                    </tr>
                    <?php endforeach;?>
                  </tbody>
                </table>
