    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="../Admin/WhatsappKontak" class="nav-link active">
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Bot List</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <?php foreach($tbl_whatsapp as $row):?>
                   <tr>
                      ...
                      ?>
                      <a href="../Admin/QRIS" class="btn btn-primary btn-flat" title="LOGIN WHATSAPP"><i class="fas fa-qrcode"></i></a>
                      <?php
                      }elseif($row->status == "DISABLE"){
