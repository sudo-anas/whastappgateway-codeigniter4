...
<div class="wrapper">
  ...
  $WidgetUser = $db->table('tbl_users');             
  $WidgetWhatsapp = $db->table('tbl_whatsapp');             
  ?>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Whatsapp Gateway Admin Dashboard</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
          </div><!-- /.col -->
        </div><!-- /.row -->
        ...
        <div class="row">
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number"><?php echo $WidgetUser->countAllResults();?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                <span class="info-box-text">WHATSAPP NUM</span>
                <span class="info-box-number"><?php echo $WidgetWhatsapp->countAllResults();?></span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <div class="info-box mb-3">
              ...
              <div class="info-box-content">
                ...
                <span class="info-box-number">5760</span>
              </div>
              <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">Whatsapp Bot Number Status</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                <table class="table table-bordered">
                  <thead>                  
                    <tr>
                      <th style="width: 10px">Owner</th>
                      <th>Number</th>
                      <th style="width: 40px">Status</th>
                    </tr>
                  </thead>                                                                              
                  <tbody>  
                  <?php foreach($tbl_whatsapp as $row):?>
                    <tr>
                      <td><?= $row->owner;?></td>
                      <td><?= $row->wano;?></td>
                      <td><?php if($row->status == "CONNECT"){
                      
                      ?>
                      <span class="badge bg-success">CONNECTED WITH SERVICE - BOT READY!</span>
                      <?php
                      }elseif($row->status == "DISCONNECT"){
