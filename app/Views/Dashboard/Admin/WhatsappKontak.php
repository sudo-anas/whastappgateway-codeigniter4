    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <div class="modal-dialog" role="document">
            ...
            <p>Your room number is: <?php echo $waID;?>.</p>                                
            <?php 
            foreach ($ResultQueryModal as $RQM)
            {            
            ?>
            <div class="form-group">
               <center><?php echo $RQM->wa_no;?></center>
            </div>
            <?php
            }
            ?>
                <div class="form-group">
                   <center><img id="qris" name="capture" src="/images/loaderwa2.gif" /></center>
                </div>
