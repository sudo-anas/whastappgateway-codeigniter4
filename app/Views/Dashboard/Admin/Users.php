    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/Admin/MyWhatsapp" class="nav-link">
              ...
              <div class="card-body">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td><?= $row->nama;?></td>
                      <td><center><?php if($row->isonline == "TRUE"){
                      
                      ?>
                      <span class="badge bg-success">USER ONLINE!</span>
                      <?php
                      }elseif($row->isonline == "FALSE"){
                      ...
                      <td><a href="/Admin/UserEdit/<?= $row->id;?>" class="btn btn-flat btn-danger"><i class="fas fa-edit"></i> EDIT</a></td>
                    </tr>
                    <?php endforeach;?>
                  </tbody>
                </table>
